...
angular.module("horodata").controller("Group", [
  "$http", "$routeParams", "$scope", "titleService", "userService", "apiService", "groupNewService", "$mdMedia", "$mdDialog", function($http, $routeParams, $scope, titleService, userService, apiService, groupNewService, $mdMedia, $mdDialog) {
