...
angular.module("horodata").directive("appMenuToolbar", [
  "titleService", "userService", "homeService", function(titleService, userService, homeService) {
    var l;
    l = function(scope, elem) {
